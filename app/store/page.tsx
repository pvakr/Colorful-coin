...
// Price helpers (₹1 everywhere in UI)
const RUPEE_PRICE = 1;
...
const BOOKS: Book[] = [
  {
    ...
    digitalPrice: 14.99,
    description:
      "An epic journey through undiscovered galaxies and the search for humanity's true home. This groundbreaking novel explores the frontiers of space travel and human resilience.",
    coverImage: "https://placehold.co/200x300/4f46e5/ffffff?text=Voyager",
  ...
  },
  {
    ...
    digitalPrice: 22.99,
    description:
      "A surprisingly accessible guide to superposition and entanglement, explained with cat analogies. Perfect for beginners and cat lovers alike.",
    coverImage:
      "https://placehold.co/200x300/047857/ffffff?text=Quantum+Cats",
    category: "Science & Tech",
    rating: 4.8,
    reviews: 567,
    bestseller: true,
  },
  {
    ...
    digitalPrice: 11.0,
    description:
      "A satirical, yet informative, look at the rise of the digital age, from ARPANET to modern memes. A must-read for tech enthusiasts.",
    coverImage:
      "https://placehold.co/200x300/e11d48/ffffff?text=Internet+History",
  ...
  },
  {
    ...
    digitalPrice: 8.99,
    description:
      "A meditative study on urban permaculture and finding peace through nature in concrete jungles. Transform your living space.",
    coverImage: "https://placehold.co/200x300/fbbf24/000000?text=Gardener",
  ...
  },
  {
    ...
    digitalPrice: 10.99,
    description:
      "A novel about AI and finding humanity in code. A touching story of love in the digital age.",
    coverImage: "https://placehold.co/200x300/3b82f6/ffffff?text=AI+Shepherd",
    category: "Science & Tech",
    rating: 4.4,
    reviews: 445,
  },
  {
    ...
    digitalPrice: 28.0,
    description:
      "A photographic journey through forgotten urban centers. Stunning photography meets historical research.",
    coverImage: "https://placehold.co/200x300/44403c/ffffff?text=Lost+Cities",
    category: "History & Lore",
    rating: 4.7,
    reviews: 278,
    bestseller: true,
  },
  {
    ...
    digitalPrice: 12.5,
    description:
      "Recipes for a future in space colonization. Scientific cooking for the aspiring astronaut chef.",
    coverImage: "https://placehold.co/200x300/6b7280/ffffff?text=Space+Food",
  ...
  },
  {
    ...
    digitalPrice: 17.99,
    description:
      "A non-fiction deep dive into theoretical physics. Explore dimensions beyond our comprehension.",
    coverImage: "https://placehold.co/200x300/7e22ce/ffffff?text=Dimension+5",
    category: "Science & Tech",
    rating: 4.9,
    reviews: 623,
    bestseller: true,
  },
  {
    ...
    digitalPrice: 9.99,
    description:
      "A thrilling mystery set on a remote coastline. Uncover secrets that have been buried for decades.",
    coverImage: "https://placehold.co/200x300/0891b2/ffffff?text=Lighthouse",
    category: "Fantasy & Fiction",
    rating: 4.5,
    reviews: 398,
    newArrival: true,
  },
  {
    ...
    digitalPrice: 7.99,
    description:
      "Practical guide to decluttering your life and mind. Transform your approach to possessions and happiness.",
    coverImage: "https://placehold.co/200x300/d97706/ffffff?text=Minimalist",
    category: "Life & Culture",
    rating: 4.6,
    reviews: 521,
  },
  {
    ...
    digitalPrice: 25.0,
    description:
      "Data-driven projection on climate change impact. Essential reading for understanding our future.",
    coverImage: "https://placehold.co/200x300/b91c1c/ffffff?text=Warming",
  ...
  },
  {
    ...
    digitalPrice: 11.5,
    description:
      "A fantasy tale involving magical mathematics. Where numbers come alive with dragon fire.",
    coverImage: "https://placehold.co/200x300/ec4899/ffffff?text=Dragon+Calc",
    category: "Fantasy & Fiction",
    rating: 4.7,
    reviews: 334,
  },
  {
    ...
    digitalPrice: 33.0,
    description:
      "An intensive programming language tutorial. Master Rust programming in just one week.",
    coverImage: "https://placehold.co/200x300/ea580c/ffffff?text=Rust+Book",
    category: "Science & Tech",
    rating: 4.8,
    reviews: 892,
    bestseller: true,
  },
  {
    ...
    digitalPrice: 8.99,
    description:
      "Collection of ancient myths and folklore. Discover the stories that shaped civilizations.",
    coverImage: "https://placehold.co/200x300/713f12/ffffff?text=Old+Gods",
    category: "History & Lore",
    rating: 4.5,
    reviews: 267,
  },
  {
    ...
    digitalPrice: 19.5,
    description:
      "Scientific guide to farming on Mars. Prepare for humanity's next giant leap.",
    coverImage: "https://placehold.co/200x300/991b1b/ffffff?text=Martian+Farm",
    category: "Hard Science",
    rating: 4.6,
    reviews: 198,
    newArrival: true,
  },
  {
    ...
    digitalPrice: 13.5,
    description:
      "A travel memoir exploring Japan's duality. Experience the contrast of ancient and modern Japan.",
    coverImage: "https://placehold.co/200x300/c026d3/ffffff?text=Tokyo",
    category: "Life & Culture",
    rating: 4.7,
    reviews: 345,
  },
  {
    ...
    digitalPrice: 15.0,
    description:
      "Philosophical inquiry into data and well-being. Can we algorithmically optimize happiness?",
    coverImage: "https://placehold.co/200x300/84cc16/ffffff?text=Algorithm",
    category: "Life & Culture",
    rating: 4.4,
    reviews: 412,
  },
  {
    ...
    digitalPrice: 20.99,
    description:
      "Exploration of the ocean's unexplored trenches. Discover life in the abyss.",
    coverImage: "https://placehold.co/200x300/1e3a8a/ffffff?text=Deep+Sea",
    category: "Hard Science",
    rating: 4.8,
    reviews: 276,
  },
  {
    ...
    digitalPrice: 6.5,
    description:
      "Survival tips for the inevitable future. Be prepared for any scenario.",
    coverImage: "https://placehold.co/200x300/000000/ffffff?text=Prep+Guide",
    category: "Fantasy & Fiction",
    rating: 4.3,
    reviews: 534,
  },
  {
    ...
    digitalPrice: 11.5,
    description:
      "A definitive guide from crop to cup. The ultimate journey of your morning brew.",
    coverImage: "https://placehold.co/200x300/92400e/ffffff?text=Coffee+History",
    category: "History & Lore",
    rating: 4.6,
    reviews: 389,
  },
...
/**
 * ✅ FIXED: QuantitySelector now uses `onChange(nextQty)` (not setState)
 * This makes it usable for BOTH local state AND cart updates.
 */
  ...
  return (
    <div className={`flex items-center border border-gray-300 rounded-lg`}>
      <button
        ...
        className={`${sizes[size]} flex items-center justify-center rounded hover:bg-gray-100 transition text-gray-700`}
      >
...
const BookGridItem = ({ book, onSelect, onQuickAdd }: BookGridItemProps) => {
  return (
    <div
      className="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full group border border-gray-200 hover:border-orange-300 hover:-translate-y-1 cursor-pointer relative"
    ...
    >
      ...
      <div className="absolute top-2 right-2 z-10 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
        <button
          ...
          className="bg-white/90 backdrop-blur p-2 rounded-full shadow-md hover:bg-gray-100 transition"
      ...
      <div className="p-4 pt-0">
        <button
          ...
          className="w-full py-2 rounded-lg bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold text-sm transition shadow-sm hover:shadow-md"
        >
          Add to Cart
        </button>
      </div>
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 z-10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              type="button"
              onClick={onHome}
              className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 text-gray-700 hover:bg-gray-50 transition"
            >
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="relative aspect-[2/3] rounded-2xl overflow-hidden bg-gray-100 shadow-lg">
                <img
                  src={book.coverImage}
                  alt={`Cover of ${book.title}`}
            ...
            <div className="space-y-6">
              ...
              <div className="border-b pb-4">
                <div className="flex items-baseline gap-3">
                  ...
                  <span className="text-lg text-gray-500 line-through">
                    {formatINR(book.price * quantity)}
                  </span>
                  <span className="text-sm text-green-600 font-medium">
                    Save {formatINR(book.price * quantity - currentPrice)}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <Package
                        className={`w-5 h-5 ${
                          isPhysical ? "text-orange-500" : "text-gray-400"
                        }`}
                      />
                      <span
                        className={`font-semibold ${
                          isPhysical ? "text-gray-900" : "text-gray-700"
                        }`}
                      >
                        Physical Book
                      </span>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Button onClick={handleProceed} icon={ArrowRight} className="py-3">
                    {isPhysical ? "Buy Now" : "Buy E-book"}
                  </Button>
                </div>
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="w-full py-3 rounded-lg border border-gray-300 text-gray-700 font-semibold hover:bg-gray-50 transition"
                >
                  Continue Shopping
                </button>
              </div>
              ...
              {isPhysical && (
                <div className="p-4 bg-gray-50 rounded-xl space-y-2">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>
                      Delivery to <strong>Your Location</strong> - 2-3 business
                      days
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-600">
...
const DigitalPayment = ({
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // If redirect succeeds, you won't reach here.
      // If redirect fails, then we fall through and stop loader.
    } catch (e) {
      console.error(e);
      setLoading(false);
      alert("Payment failed to start. Check backend is running + env URL.");
    }
  };
    ...
    <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full border border-gray-100 overflow-hidden">
      ...
      <div className="p-6">
          ...
          <div className="space-y-2 text-sm">
            {items.map((item, idx) => (
              <div key={idx} className="flex justify-between text-gray-600">
                ...
                <span>{formatINR(RUPEE_PRICE * item.quantity)}</span>
              </div>
            ))}
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={handlePayment} disabled={loading} className="flex-1 py-3">
            {loading ? (
              <>
        ...
        <div className="mt-6 flex items-center justify-center gap-4 text-xs text-gray-400">
          ...
          <span className="flex items-center gap-1">
            <CreditCardIcon className="w-3 h-3" /> PCI Compliant
          </span>
        </div>
      </div>
    </div>
...
const SuccessView = ({ message, onStartOver }: SuccessViewProps) => (
  <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full border border-gray-100 overflow-hidden">
    ...
    <div className="p-6 text-center">
      ...
      <Button onClick={onStartOver} icon={ArrowRight} className="w-auto px-8">
        Continue Shopping
      </Button>
    </div>
  </div>
...
const ExternalRedirectView = ({ title, amount, onStartOver }: ExternalRedirectViewProps) => (
  <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full border border-gray-100 overflow-hidden">
    <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white">
      ...
      <h2 className="text-xl font-bold">Physical Order Confirmed</h2>
    </div>
    <div className="p-6">
      <div className="bg-gray-50 rounded-xl p-4 mb-6">
      ...
      <p className="text-gray-600 mb-6">
        To complete your physical order and provide delivery details, you'll be redirected to our shipping partner.
      </p>
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 w-full py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold transition shadow-md hover:shadow-lg mb-4"
      >
        <Truck className="w-5 h-5" />
        Proceed to Shipping Portal
      </a>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    <span className="text-sm text-gray-500 line-through">
                      {formatINR(item.unitPrice * 5 * item.quantity)}
                    </span>
                    <span className="text-xs text-green-600 font-medium">
                      Save {formatINR(item.unitPrice * 4 * item.quantity)}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <QuantitySelector
                      ...
                      onChange={(next) => onUpdateQty(item.bookId, item.format, next)}
                      size="sm"
                    />
...
export default function StorePage() {
  ...
  const handleBuyCart = () => {
    ...
    setCheckoutAmount(total);
    setCheckoutItems(
      cart.map((i) => ({ title: `${i.title} (${i.format})`, quantity: i.quantity }))
    );
        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 flex flex-col items-center py-3 px-5 rounded-xl transition-all duration-200 ${
                isActive
            ...
            >
              <div
                className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 ${cat.color} text-white shadow-sm ${
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between py-4 gap-4">
            ...
            >
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-500">Your favorite reads</p>
              </div>
            </div>
            ...
            <div className="flex-1 max-w-2xl">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all"
                />
                <button
                  type="button"
                  className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 bg-orange-500 hover:bg-orange-600 rounded-lg transition"
                >
          ...
          <div className="flex items-center gap-6 py-2 text-sm border-t border-gray-100">
            ...
            <button type="button" className="text-gray-600 hover:text-orange-600 transition">
              Today's Deals
            </button>
            <button type="button" className="text-gray-600 hover:text-orange-600 transition">
              Bestsellers
            ...
            <button
              type="button"
              className="text-gray-600 hover:text-orange-600 transition hidden sm:inline"
            >
              New Arrivals
            </button>
            <button
